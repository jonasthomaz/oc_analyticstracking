<?php 
/*
	Action do Módulo para Google Analytics 
	Jonas Thomaz de Faria
	http://www.oficinadopixel.com.br
...
class ControllerModuleGoogleAnalytics extends Controller{
	...
	public function index() {   
		$this->language->load('module/google_analytics');
 		...
 		if (isset($this->error['code'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/google_analytics', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('module/google_analytics', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['google_analytics_module'])) {
			$this->data['modules'] = $this->request->post['google_analytics_module'];
		} elseif ($this->config->get('google_analytics_module')) { 
			$this->data['modules'] = $this->config->get('google_analytics_module');
		}			
